...
const ProductInteraction = ({
  ...
  return (
              ...
              {product.sizes.map((size) => (
                  <div 
                    ...
                    className={`cursor-pointer border-1 p-[2px] ${
                      ...
                      <div className={`w-6 h-6 flex items-center justify-center ${selectedSize === size ? "bg-black text-white" : "bg-white"}`}>{size.toUpperCase()}</div>
                  </div>
              ))}
          </div>
      </div>
    ...
    <button className="ring-1 ring-gray-400 shadow-lg text-gray-800 px-4 py-2 rounded-md
